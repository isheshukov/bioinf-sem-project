...
class BO(object):
    ...
    def run_optimization(self, max_iter = 0, max_time = np.inf,  eps = 1e-8, context = None, verbosity=False, save_models_parameters= True, report_file = None, evaluations_file = None, models_file=None):
        ...
        if self.X is not None and self.Y is None:
            ...
            # <vabor112>
            #print('self.Y from initial function evaluation: ', self.Y)
            # </vabor112>
        ...
        while (self.max_time > self.cum_time):
            ...
            # <vabor112>
            print('Suggested sample (num_acquisitions = %06d):' % self.num_acquisitions)
            #print(self.suggested_sample)
            print(', '.join('%0.3f' % one_dim for one_dim in self.suggested_sample[0]))
            # </vabor112>
            ...
            # <vabor112>
            #print('Current number of acquisitions:' + str(self.num_acquisitions))
            # </vabor112>
            ...
            if verbosity:
                ...
                # <vabor112>
                #print('IFSTART Current number of acquisitions:', self.num_acquisitions)
                plot_acquisition(self.acquisition.space.get_bounds(),
                                 ...
                                 [],
                                 '/home/vabor112/slava/workspace/bio/sheshukov_project/bioinf-sem-project/outfixed2/plotsbyiteration/acquisition_%05d.png' % self.num_acquisitions)
                #self.plot_acquisition(filename='/home/vabor112/slava/workspace/bio/sheshukov_project/bioinf-sem-project/outfixed2/plotsbyiteration/acquisition_%5d.png' % self.num_acquisitions)
                #print('IFEND Current number of acquisitions:', self.num_acquisitions)
                print('')
                print('******************************************************************')
                print('Current optimum: %0.3f'% np.min(self.Y))
                print('******************************************************************')
                print('')
                # </vabor112>
    ...
    def _update_model(self, normalization_type='stats'):
        ...
        if self.num_acquisitions % self.model_update_interval == 0:
            # <vabor112>
            #print('Inside if of _update_model')
            # </vabor112>
    ...
    def _save_model_parameter_values(self):
        # <vabor112>
        print('')
        print('====================== Iteration %05d ======================' % self.num_acquisitions)
    ...
    def plot_acquisition(self,filename=None):
        ...
        """
        # <vabor112>
        # print('Current number of acquisitions (1):', self.num_acquisitions)
        # </vabor112>
        ...
        # <vabor112>
        # print('Current number of acquisitions (2):', self.num_acquisitions)
        # </vabor112>
        ...
        # </vabor112>
        # <vabor112>
        # print('Current number of acquisitions (3):', self.num_acquisitions)
        # </vabor112>
